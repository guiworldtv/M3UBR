...
# TVI Internacional - update the stream URL of TVI Reality

sed -i "/live_tvi_direct/ c https://video-auth7.iol.pt/live_tvi_direct/live_tvi_direct/edge_servers/tvireality-720_passthrough/chunks.m3u8?nimblesessionid=184934045&wmsAuthSign$(wget https://services.iol.pt/matrix?userId= -o /dev/null -O -)/" m3upt.m3u
